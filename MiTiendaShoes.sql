DROP DATABASE IF EXISTS MiTiendaShoes
GO
CREATE DATABASE MiTiendaShoes
GO
USE MiTiendaShoes
GO
...
INSERT INTO Marcas (Nombre, FechaModifica, IpModifica) VALUES
('Nike', '2021-03-10','192.168.0.1'),
('Puma', '2021-03-10','192.168.0.1');

INSERT INTO Tipos(Nombre, FechaModifica, IpModifica) VALUES
('De vestir', '2021-03-10','192.168.0.1'),
('Sports', '2021-03-10','192.168.0.1');

INSERT INTO Categorias(Nombre, FechaModifica, IpModifica) VALUES
('Niños', '2021-03-10','192.168.0.1'),
('Hombre', '2021-03-10','192.168.0.1'),
('Mujer', '2021-03-10','192.168.0.1');