...
{
    public partial class MiTiendaShoesContext : DbContext
    {
        public MiTiendaShoesContext()
        {
        }

        public MiTiendaShoesContext(DbContextOptions<MiTiendaShoesContext> options)
            : base(options)
        {
        }
